...
export default class DynamicOptionList extends React.Component {
  ...
  render() {
    ...
    if (this.props.element.element !== "List") {
      return (
          ...
          <ul>
            <li>
              <div className="row">
                ...
                <div className="col-sm-6"><b>Value</b></div> }
                ...
                return (
                  <li className="clearfix" key={this_key}>
                    <div className="row">
                      ...
                      { this.props.canHaveOptionValue &&
                      <div className="col-sm-6">
                        <input disabled className="form-control" type="text" name={`value_${index}`} value={val} onChange={this.editValue.bind(this, index)} />
                      </div> }
                      {/* { this.props.canHaveOptionValue && this.props.canHaveOptionCorrect &&
