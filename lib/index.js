  ...
  _createClass(ReactFormBuilder, [{
    ...
    value: function render() {
      ...
      if (this.props.customAttributes) {
        toolbarProps.customAttributes = this.props.customAttributes;
      }

      if (this.props.lists) {
        toolbarProps.lists = this.props.lists;
      }

      return _react["default"].createElement("div", {
        className: "phion-builder"
...
var FormBuilders = {};
var FormBuilder = (0, _reactDnd.DragDropContext)(_reactDndHtml5Backend["default"])(ReactFormBuilder);
exports.ReactFormBuilder = FormBuilder;
