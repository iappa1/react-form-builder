...
function (_React$Component6) {
  _inherits(Lists, _React$Component6);
  ...
  function Lists(props) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Lists).call(this, props));
    _this2.options = {};
    return _this2;
  }
...
function (_React$Component7) {
  _inherits(Attributes, _React$Component7);
  ...
  function Attributes(props) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(Attributes).call(this, props));
    _this4.options = {};
    ...
    value: function render() {
      ...
      if (this.props.data && this.props.data.configuration && this.props.data.configuration.type === "boolean") {
        ...
        return _react["default"].createElement("div", {
          ...
          var this_key = "preview_".concat(option.key);
          var props = {};
          props.name = _this5.props.data.field_name;
          props.type = 'radio';
          props.value = option.value;

          if (_this5.props.mutable) {
            props.defaultChecked = _this5.props.defaultValue;
          }

          if (_this5.props.read_only) {
            props.disabled = 'disabled';
          }
          ...
          return _react["default"].createElement("label", {
            ...
            ref: function ref(c) {
              if (c && _this5.props.mutable) {
                _this5.options["child_ref_".concat(option.key)] = c;
              }
            }
          }, props)), " ", option.text);
        })));
        ...
        var _baseClasses = 'SortableItem rfb-item';

        if (this.props.data.pageBreakBefore) {
          _baseClasses += ' alwaysbreak';
        }
...
function (_React$Component8) {
  ...
  function NumberInput(props) {
    ...
    _this6 = _possibleConstructorReturn(this, _getPrototypeOf(NumberInput).call(this, props));
...
function (_React$Component9) {
  _inherits(EmailInput, _React$Component9);
  ...
  function EmailInput(props) {
    ...
    _this7 = _possibleConstructorReturn(this, _getPrototypeOf(EmailInput).call(this, props));
...
function (_React$Component10) {
  ...
  function PhoneInput(props) {
    ...
    _this8 = _possibleConstructorReturn(this, _getPrototypeOf(PhoneInput).call(this, props));
    _this8.inputField = _react["default"].createRef();
    return _this8;
  }
...
function (_React$Component11) {
  _inherits(DateInput, _React$Component11);
  ...
  function DateInput(props) {
    ...
    _this9 = _possibleConstructorReturn(this, _getPrototypeOf(DateInput).call(this, props));
    _this9.inputField = _react["default"].createRef();
    return _this9;
  }
...
function (_React$Component12) {
  _inherits(TextArea, _React$Component12);
  ...
  function TextArea(props) {
    ...
    _this10 = _possibleConstructorReturn(this, _getPrototypeOf(TextArea).call(this, props));
    _this10.inputField = _react["default"].createRef();
    return _this10;
  }
...
function (_React$Component13) {
  _inherits(DatePicker, _React$Component13);
  ...
  function DatePicker(props) {
    ...
    _this11 = _possibleConstructorReturn(this, _getPrototypeOf(DatePicker).call(this, props));

    _defineProperty(_assertThisInitialized(_this11), "formatMask", '');

    _defineProperty(_assertThisInitialized(_this11), "handleChange", function (dt) {
      var placeholder;

      if (dt && dt.target) {
        placeholder = dt && dt.target && dt.target.value === '' ? _this11.formatMask.toLowerCase() : '';
        var formattedDate = dt.target.value ? (0, _dateFns.format)(dt.target.value, _this11.formatMask) : '';
        ...
        _this11.setState({
          value: dt ? (0, _dateFns.format)(dt, _this11.formatMask) : '',
          internalValue: dt,
          placeholder: placeholder
        });
      }
    ...
    _this11.updateFormat(props);

    _this11.state = _this11.updateDateTime(props, _this11.formatMask);
    return _this11;
  }
...
function (_React$Component14) {
  ...
  function Dropdown(props) {
    ...
    _this12 = _possibleConstructorReturn(this, _getPrototypeOf(Dropdown).call(this, props));
...
function (_React$Component15) {
  _inherits(Signature, _React$Component15);
  ...
  function Signature(props) {
    ...
    _this13 = _possibleConstructorReturn(this, _getPrototypeOf(Signature).call(this, props));

    _defineProperty(_assertThisInitialized(_this13), "clear", function () {
      if (_this13.state.defaultValue) {
        _this13.setState({
          defaultValue: ''
        });
      } else if (_this13.canvas.current) {
        _this13.canvas.current.clear();
      }
    });
    ...
    _this13.canvas = _react["default"].createRef();
    return _this13;
  }
...
function (_React$Component16) {
  _inherits(Tags, _React$Component16);
  ...
  function Tags(props) {
    ...
    _this14 = _possibleConstructorReturn(this, _getPrototypeOf(Tags).call(this, props));

    _defineProperty(_assertThisInitialized(_this14), "handleChange", function (e) {
      _this14.setState({
        value: e
      });
    });
    ...
    var defaultValue = props.defaultValue,
        data = props.data;
    _this14.state = {
      value: _this14.getDefaultValue(defaultValue, data.options)
    };
    return _this14;
  }
...
function (_React$Component17) {
  _inherits(Checkboxes, _React$Component17);
  ...
  function Checkboxes(props) {
    ...
    _this15 = _possibleConstructorReturn(this, _getPrototypeOf(Checkboxes).call(this, props));
    _this15.options = {};
    return _this15;
  }
...
function (_React$Component18) {
  _inherits(RadioButtons, _React$Component18);
  ...
  function RadioButtons(props) {
    ...
    _this17 = _possibleConstructorReturn(this, _getPrototypeOf(RadioButtons).call(this, props));
    _this17.options = {};
    return _this17;
  }
...
function (_React$Component19) {
  _inherits(Image, _React$Component19);
...
function (_React$Component20) {
  _inherits(Rating, _React$Component20);
  ...
  function Rating(props) {
    ...
    _this19 = _possibleConstructorReturn(this, _getPrototypeOf(Rating).call(this, props));
    _this19.inputField = _react["default"].createRef();
    return _this19;
  }
...
function (_React$Component21) {
  _inherits(HyperLink, _React$Component21);
...
function (_React$Component22) {
  _inherits(Download, _React$Component22);
...
function (_React$Component23) {
  _inherits(Camera, _React$Component23);
  ...
  function Camera(props) {
    ...
    _this20 = _possibleConstructorReturn(this, _getPrototypeOf(Camera).call(this, props));

    _defineProperty(_assertThisInitialized(_this20), "displayImage", function (e) {
      var self = _assertThisInitialized(_this20);
    ...
    _defineProperty(_assertThisInitialized(_this20), "clearImage", function () {
      _this20.setState({
        img: null
      });
    });
...
function (_React$Component24) {
  _inherits(Range, _React$Component24);
  ...
  function Range(props) {
    ...
    _this21 = _possibleConstructorReturn(this, _getPrototypeOf(Range).call(this, props));

    _defineProperty(_assertThisInitialized(_this21), "changeValue", function (e) {
      var target = e.target;
    ...
    _this21.inputField = _react["default"].createRef();
    _this21.state = {
  ...
  _createClass(Range, [{
    ...
    value: function render() {
      ...
      }, this.props.data.max_label))), _react["default"].createElement("div", {
