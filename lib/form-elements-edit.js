...
var _ColorPic = _interopRequireDefault(require("./ColorPic"));
  ...
  _createClass(FormElementsEdit, [{
    ...
    value: function editElementProp(elemProperty, targProperty, e) {
      ...
      if (elemProperty === 'selected_attribute') {
        var conf = this.props.customAttributes.find(function (o) {
        ...
        if (e.target.checked) {
          this_element.options.push({
            ...
            text: e.target.name,
            key: "radiobuttons_option_".concat(e.target.value)
          });
          this_element.selected_lists.push(e.target.value);
        } else {
          this_element.options = this_element.options.filter(function (arrayItem) {
            return arrayItem.value !== e.target.value;
          });
          this_element.selected_lists = this_element.selected_lists.filter(function (arrayItem) {
    ...
    value: function render() {
      ...
      var this_custom_attributes = this.props.customAttributes && this.props.customAttributes.length > 0 ? this.props.customAttributes : [];
      var available_lists = this.props.lists && this.props.lists.length > 0 ? this.props.lists : [];
      ...
      }))), this.props.element.element === 'Attributes' && this_custom_attributes.length > 0 ? _react["default"].createElement("div", {
        className: "form-group"
      }, _react["default"].createElement("label", {
        className: "control-label"
      }, "Select Attribute"), _react["default"].createElement("select", {
        defaultValue: this.props.element.selected_attribute || 'select',
        className: "form-control",
        onBlur: this.updateElement.bind(this),
        onChange: this.editElementProp.bind(this, 'selected_attribute', 'value')
      }, _react["default"].createElement("option", {
        value: "select",
        disabled: true
      }, "Select"), this_custom_attributes.map(function (attr) {
        return _react["default"].createElement("option", {
          value: attr.name,
          key: attr.name
        }, attr.name);
      }))) : _react["default"].createElement(_react["default"].Fragment, null), this.props.element.element === 'List' && available_lists.length > 0 ? _react["default"].createElement("div", {
        className: "form-group"
      }, _react["default"].createElement("label", {
        className: "control-label"
      }, _react["default"].createElement("b", null, "Select Lists")), _react["default"].createElement("br", null), available_lists.map(function (attr) {
        console.log(_this3.state.element.selected_lists);

        if (_this3.state.element.selected_lists.includes(attr.list_id.toString())) {
          return _react["default"].createElement("div", null, _react["default"].createElement("label", null, _react["default"].createElement("input", {
            checked: true,
            type: "checkbox",
            value: attr.list_id,
            name: attr.list_name,
            key: attr.list_id,
            style: marr,
            onChange: _this3.editElementProp.bind(_this3, 'selected_lists', 'value')
          }), attr.list_name));
        } else {
          return _react["default"].createElement("div", null, _react["default"].createElement("label", null, _react["default"].createElement("input", {
            type: "checkbox",
      ...
      }), _react["default"].createElement("hr", null)) : _react["default"].createElement(_react["default"].Fragment, null), this.props.element.hasOwnProperty('href') && _react["default"].createElement("div", {
        className: "form-group"
      ...
      }), _react["default"].createElement("br", null), this.state.element.selected_attribute ? _react["default"].createElement("div", {
        className: "checkbox"
      }, _react["default"].createElement("label", null, _react["default"].createElement("input", {
      ...
      }), "Required")) : _react["default"].createElement(_react["default"].Fragment, null), this.props.element.hasOwnProperty('readOnly') && _react["default"].createElement("div", {
        className: "checkbox"
      }, _react["default"].createElement("label", null, _react["default"].createElement("input", {
        type: "checkbox",
      ...
      })), this.props.element.hasOwnProperty('options') && _react["default"].createElement(_dynamicOptionList["default"], {
